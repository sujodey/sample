pipeline {
	...
	post {
        always {
               ...
               emailext attachLog: true, body: " <h1>Build Result</h1> <h2> ${currentBuild.result}:</h2>  <h3> Please find the MUnit&Integration test Results from Below link</h3> <h2>${BUILD_URL}/htmlreports/Munit_20Report/MunitReport-${BUILD_ID}.html</h2>", compressLog: true, replyTo: 'satheesh.chitti@capgemini.com',
