pipeline {
	...
	post {
        always {
               ...
               emailext attachLog: true, body: " <h1>Build Result</h1> <h2> ${currentBuild.result}:</h2>  <h3> Please find the MUnit&Integration test Results from Below link</h3> <h2><a href="${WORKSPACE}/${BUILD_ID}/Munit_20Report/"></a></h2>", compressLog: true, replyTo: 'satheesh.chitti@capgemini.com',
