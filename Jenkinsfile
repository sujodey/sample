pipeline {
	...
	post {
        always {
               ...
               emailext attachLog: true, body: " Build Result <h2> ${currentBuild.result}:</h2>  Please find the MUnit&Integration test Results from Below link ${BUILD_URL}", compressLog: true, replyTo: 'satheesh.chitti@capgemini.com',
